...
function Navbar() {
  ...
  return (
    ...
    className={`flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-24 py-3.5 text-gray-600 border-b border-borderColor relative transition-all shadow sticky top-0 z-100
    ${location.pathname === '/' ? 'bg-light' : 'bg-white'} `}>
        ...
        <div className={`max-sm:fixed max-sm:h-screen text-sm max-sm:w-full max-sm:top-16 max-sm:border-t border-borderColor right-0 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-8 max-sm:p-4
